...
def scrape_uci_datasets():
    ...
    headers = [
        "Dataset Name", "Donated Date", "Description", "Dataset Characteristics", "Subject Area", "Associatd Feature Type", "Instances", "Features"
    ]
    ...
    print("Scraping fnished. Saved to 'uci_datasets.csv' .")
